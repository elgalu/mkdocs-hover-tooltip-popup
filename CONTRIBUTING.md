...
```bash
git clone https://github.com/elgalu/mkdocs-hover-tooltip-popup.git
cd mkdocs-panzoom
make setup
...
1. **Build wheel and source distribution**:
   ...
   + `mkdocs_hover_tooltip_popup-X.Y.Z-py3-none-any.whl` (wheel)
   + `mkdocs_hover_tooltip_popup-X.Y.Z.tar.gz` (source distribution)
...
1. **Test in a clean environment**:
   ...
   pip install dist/mkdocs_hover_tooltip_popup-*.whl

   # Test basic functionality
   python -c "from mkdocs_hover_tooltip_popup.plugin import HoverTooltipPopupPlugin; print('✅ Import successful')"
...
# With coverage
uv run pytest --cov=mkdocs_hover_tooltip_popup --cov-report=html
...
- **Issues**: [GitHub Issues](https://github.com/elgalu/mkdocs-hover-tooltip-popup/issues)
- **Discussions**: [GitHub Discussions](https://github.com/elgalu/mkdocs-hover-tooltip-popup/discussions)
- **Documentation**: [Project Docs](https://elgalu.github.io/mkdocs-hover-tooltip-popup/)
